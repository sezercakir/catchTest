...
namespace Detail {
    ...
    public:
        ...
        [[maybe_unused]] double getEpsilon(){ return m_epsilon;}
        [[maybe_unused]] double getMargin(){ return m_margin;}
        [[maybe_unused]] double getScale(){ return m_scale;}
        [[maybe_unused]] double getValue(){ return m_value;}
